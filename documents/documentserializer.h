...
private:
    ...
    static bool deserializeBlocks(DocumentTab *document, const QJsonArray &blocks);
    static bool deserializeVariables(DocumentTab *document, const QJsonArray &variables);
    static bool deserializeConnections(DocumentTab *document, const QJsonArray &connections);
};
